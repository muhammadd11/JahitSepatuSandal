...
<p>      <a href="https://www.grab.com/id/rideguide/" class="btn btnNext">INFO LANJUT</a>
									...
									id="section-download-download-app" 
										class="section section--padded section--dark section-download bg-size-cover" 
											style="background-image: url(https://assets.grab.com/wp-content/uploads/sites/9/2016/04/15120125/dg-dl-grab-back.jpg);												">
				
									<div class="container">
										<header><h2>Download Grab</h2></header>										<div class="dl--well clearfix center-block">
								            <div class="dl--qr-code">
								                <span class="weight-bold block bottom-margin-sm">Scan Kode QR</span>
								                <img class="img-responsive img--qr-code" src="https://www.grab.com/id/wp-content/uploads/sites/9/2016/05/pax_id.jpg">
								            </div><!-- /dl--qr-code -->
								            <div class="dl--stores">
									            								                <a class="bottom-margin-sm" href="https://app.appsflyer.com/id647268330?pid=ID-Website-IOS-Install_Button&c=Website_Download" onclick="ga('send', { hitType: 'event', eventCategory: 'Website', eventAction: 'Download', eventLabel: 'Web'});" target="_blank"><img class="img-responsive" src="https://www.grab.com/id/wp-content/uploads/sites/9/2016/05/app-store.png"></a>
								                								                								                <a class="bottom-margin-sm" href="https://app.appsflyer.com/com.grabtaxi.passenger?pid=ID-Website-ADR-Install_Button&c=Website_Download" onclick="ga('send', { hitType: 'event', eventCategory: 'Website', eventAction: 'Download', eventLabel: 'Web'});" target="_blank"><img class="img-responsive" src="https://www.grab.com/id/wp-content/uploads/sites/9/2016/05/google-play.png"></a>
								                								            </div><!-- /dl--stores -->
										</div><!-- /dl--well -->
		...
		<!-- /section -->
				...
				<div class="container">
					...
					<header>
						<h2>Momen-momen terbaik</h2>
						<p>Dekat dengan Grab</p>
					</header>
					
					<div class="row">
													<div class="col-xs-12 col-sm-12 col-md-8 latest">
									<div class="box bg-size-cover bottom-margin-md" style="background-image:url(https://assets.grab.com/wp-content/uploads/sites/9/2019/08/06164509/WhatsApp-Image-2019-08-06-at-15.36.56.jpeg);">
										<div class="blurb">
											<span class="date block">Agustus 6, 2019</span>
											<span class="weight-bold">OVO, Grab, dan Tokopedia Salurkan Harapan Baru  untuk Anak Yatim di Indonesia</span>
										</div>
										<div class="excerpt">
											<div class="centered-wrapper">
												<div class="centered">
													OVO, Grab dan Tokopedia, melalui program kolektifnya, Patungan Untuk Berbagi, telah mengumpulkan donasi sejumlah lebih dari IDR 11 milyar untuk memastikan pendidikan yang berkelanjutan bagi anak yatim di Indonesia.													<a rel="bookmark" href="https://www.grab.com/id/press/social-impact-safety/ovo-grab-dan-tokopedia-salurkan-harapan-baru-untuk-anak-yatim-di-indonesia/" title="OVO, Grab, dan Tokopedia Salurkan Harapan Baru  untuk Anak Yatim di Indonesia">Know More</a>
												</div>
											</div>
										</div>
									...
									<div class="box bg-size-cover bottom-margin-md" style="background-image:url(https://assets.grab.com/wp-content/uploads/sites/9/2019/08/02091546/GrabBike-AntiNgaret-1.jpg);">
										<div class="blurb">
											<span class="date block">Agustus 2, 2019</span>
											<span class="weight-bold">Masih Suka ‘Ngaret’? Ini 5 Hal yang Akan Terlewatkan Kalau Kamu Suka ‘Ngaret’!</span>
										</div>
										<div class="excerpt">
											<div class="centered-wrapper">
												<div class="centered">
													Apakah kamu punya teman yang suka datang terlambat? Atau jangan-jangan, kamu sendiri yang termasuk orang yang suka ‘ngaret’? 													<a rel="bookmark" href="https://www.grab.com/id/press/consumers-drivers/masih-suka-ngaret-ini-5-hal-yang-akan-terlewatkan-kalau-kamu-suka-ngaret/" title="Masih Suka ‘Ngaret’? Ini 5 Hal yang Akan Terlewatkan Kalau Kamu Suka ‘Ngaret’!">Know More</a>
												</div>
											</div>
										</div>
						    								...
						    								<div class="col-xs-12 col-sm-6 col-md-4">
									<div class="box bg-size-cover bottom-margin-md" style="background-image:url(https://assets.grab.com/wp-content/uploads/sites/9/2019/08/01174241/GG_GRAB_ID_00817.jpg);">
										<div class="blurb">
											<span class="date block">Agustus 1, 2019</span>
											<span class="weight-bold">Mari Jelajahi Keindahan Indonesia Bersama Grab</span>
										</div>
										<div class="excerpt">
											<div class="centered-wrapper">
												<div class="centered">
													Grab ingin membuat pengalaman wisata pengguna menjadi lebih mudah, nyaman dan aman. 													<a rel="bookmark" href="https://www.grab.com/id/press/tech-product/mari-jelajahi-keindahan-indonesia-bersama-grab/" title="Mari Jelajahi Keindahan Indonesia Bersama Grab">Know More</a>
												</div>
											</div>
										</div>
						    								...
						    								<div class="col-xs-12 col-sm-6 col-md-4">
									<div class="box bg-size-cover bottom-margin-md" style="background-image:url(https://assets.grab.com/wp-content/uploads/sites/9/2019/07/29124950/WhatsApp-Image-2019-07-29-at-11.36.45.jpeg);">
										<div class="blurb">
											<span class="date block">Juli 29, 2019</span>
											<span class="weight-bold">SoftBank Investasikan USD 2 Miliar melalui Grab untuk Dukung Infrastruktur Digital Indonesia</span>
										</div>
										<div class="excerpt">
											<div class="centered-wrapper">
												<div class="centered">
													Grab hari ini mengumumkan investasi sebesar USD 2 miliar untuk Indonesia selama lima tahun ke depan melalui modal yang diinvestasikan oleh SoftBank dalam rangka mendukung pengembangan infrastruktur digital di Indonesia. 													<a rel="bookmark" href="https://www.grab.com/id/press/business/softbank-investasikan-usd-2-miliar-melalui-grab-untuk-dukung-infrastruktur-digital-indonesia/" title="SoftBank Investasikan USD 2 Miliar melalui Grab untuk Dukung Infrastruktur Digital Indonesia">Know More</a>
												</div>
											</div>
										</div>
						    								...
						    								<div class="col-xs-12 col-sm-6 col-md-4">
									<div class="box bg-size-cover bottom-margin-md" style="background-image:url(https://assets.grab.com/wp-content/uploads/sites/9/2019/07/25180615/Acara-TambahSukesDenganGrab-Express.jpg);">
										<div class="blurb">
											<span class="date block">Juli 25, 2019</span>
											<span class="weight-bold">GrabExpress &#038; BEKRAF Hadirkan Fitur Khusus dan Latih 400 Wirausahawan Mikro untuk Dukung Pertumbuhan Bisnis di Indonesia</span>
										</div>
										<div class="excerpt">
											<div class="centered-wrapper">
												<div class="centered">
													GrabExpress, layanan kurir milik Grab, bekerja sama dengan Badan Ekonomi Kreatif (BEKRAF) memberikan pelatihan seputar pengelolaan bisnis, pemasaran digital dan hak kekayaan intelektual kepada lebih dari 400 wirausahawan mikro di Indonesia. 													<a rel="bookmark" href="https://www.grab.com/id/press/tech-product/grabexpress-bekraf-hadirkan-fitur-khusus-dan-latih-400-wirausahawan-mikro-untuk-dukung-pertumbuhan-bisnis-di-indonesia/" title="GrabExpress &#038; BEKRAF Hadirkan Fitur Khusus dan Latih 400 Wirausahawan Mikro untuk Dukung Pertumbuhan Bisnis di Indonesia">Know More</a>
												</div>
											</div>
										</div>
					...
					<div class="row">
						<div class="col-sm-2 col-sm-offset-5">
							<a href="https://www.grab.com/id/press/" class="btn btn-block btn-primary weight-bold">View More</a>
						</div>
					</div>
		...
		<div class="container">
					...
					<div class="col-sm-12 col-md-3" >
						<div class="footer-about-grab" >
							<div class="grab-logo bottom-margin-md">
								<a href="https://www.grab.com/id/"><img src="https://www.grab.com/id/wp-content/themes/grabsg/images/grab-white.png" /></a>
							</div>
						...
						<div class="row sitemap-container" >
							...
							<div class="col-xs-6 col-sm-4 col-md-4" >
								...
								<ul class="sitemapList" id="menu-company-menu">
									<li class="menu-item" id="menu-item-1040"><a href="https://www.grab.com/id/about/">Tentang Kami</a></li>
									<li class="menu-item" id="menu-item-1047"><a href="https://www.grab.com/id/press/">Media</a></li>
									<li class="menu-item"><a href="https://www.grab.com/id/safety/">Keamanan</a></li>
									
																			<li class="menu-item" id="menu-item-1038"><a href="https://www.grab.com/id/security/">Security</a></li>
									
																	    <li class="menu-item"><a href="https://www.grab.com/id/partnerships/">Mitra</a></li>
									<li class="menu-item" id="menu-item-1039"><a href="https://grab.careers" target="_blank">Karir</a></li>
									<li class="menu-item" id="menu-item-1050"><a href="https://www.grab.com/id/driver/gdc">Driver Centre</a></li>
									<li class="menu-item"><a href="https://www.grab.com/id/driver/">Bergabung dengan Grab</a></li>			
	            				</ul>
							</div><!-- /col-xs-6 col-sm-4 col-md-3 -->

							<div class="col-xs-6 col-sm-4 col-md-4" >
								<h4 class="text-caps">Layanan</h4>
								<div style="float: left; margin-right: 15px;">
									<ul id="menu-footer-services" class="sitemapList">
										<li class="menu-item"><a href="https://www.grab.com/id/taxi/">GrabTaxi</a></li>
										<li class="menu-item"><a href="https://www.grab.com/id/car/">GrabCar</a></li>
										<!--li class="menu-item"><a href="https://www.grab.com/id/taxi/">GrabShare</a></li-->
										<li class="menu-item"><a href="https://www.grab.com/id/rent/">GrabRent</a></li>
										<li class="menu-item"><a href="https://www.grab.com/id/trip-planner/">Rute</a></li>
										<li class="menu-item"><a href="https://www.grab.com/id/wheels/">GrabWheels</a></li>
										<li class="menu-item"><a href="https://www.grab.com/id/bus/">Bus</a></li>
									</ul>
								</div>
								
								<div>
									<ul id="menu-footer-services" class="sitemapList">
										<li class="menu-item"><a href="https://www.grab.com/id/food/">GrabFood</a></li>
										<li class="menu-item"><a href="https://www.grab.com/id/express/">GrabExpress</a></li>
										<li class="menu-item"><a href="https://www.grab.com/id/business/">Grab for Business</a></li>
										<li class="menu-item"><a href="https://www.grab.com/id/blog/">Blog</a></li>
										<li class="menu-item"><a href="https://www.grab.com/id/food-blog/">Food Blog</a></li>
										<li class="menu-item"><a href="https://food.grab.com/id">GrabFood menu</a></li>
									</ul>
								</div>
	            			</div>
				            
				            <div class="col-xs-6 col-sm-4 col-md-4" >
				            	<h4 class="text-caps">Pusat Bantuan</h4>
				            	<ul id="menu-footer-services" class="sitemapList">
				            		<li class="menu-item"><a href="https://help.grab.com/passenger">Bantuan untuk penumpang</a></li>
				            		<li class="menu-item"><a href="https://help.grab.com/driver">Bantuan untuk mitra pengemudi</a></li>
				            		<li class="menu-item"><a href="https://help.grab.com/merchant">Bantuan untuk merchant</a></li>
				            	</ul>
				            </div><!-- /col-xs-6 col-sm-4 col-md-3 -->
			...
			<div class="row " >
				<div class="col-xs-6 col-sm-4 col-md-3 socialArea" >
					<div class="row hidden-xs">
						<div class="col-xs-12" >
							<h4 class="text-caps">KUNJUNGI</h4>
	        			</div>
	        		</div><!-- /row-->

										<div class="row" >
												<div class="col-xs-4" >
							<a target="_blank" href="https://www.facebook.com/grabid" class="fb socialIcon hvr-float-shadow" ><i class="fa fa-facebook fa-2x"></i></a>
						</div>
																		<div class="col-xs-4" >
							<a target="_blank" href="https://www.instagram.com/grabid" class="instagram socialIcon hvr-float-shadow" ><i class="fa fa-instagram fa-2x"></i></a>
						</div>
																		<div class="col-xs-4" >
							<a target="_blank" href="https://www.twitter.com/grabid" class="twitter socialIcon hvr-float-shadow" ><i class="fa fa-twitter fa-2x"></i></a>
						</div>
							        		</div><!-- /row-->
		...
		<div class="container" >
			<div class="row">
				...
				<div class="col-xs-12 col-md-4 hidden-xs">
					<ul class="playstore">
											<li><a onClick="ga('send', { hitType: 'event', eventCategory: 'Website', eventAction: 'Download',  eventLabel: 'Web'});" target="_blank" href="https://app.appsflyer.com/id647268330?pid=ID-Website-IOS-Install_Button&c=Website_Download" ><img src="https://www.grab.com/id/wp-content/uploads/media/images/footer/app-store.png" class="img-responsive" /></a></li>
						<li><a onClick="ga('send', { hitType: 'event', eventCategory: 'Website', eventAction: 'Download',  eventLabel: 'Web'});" target="_blank" href="https://app.appsflyer.com/com.grabtaxi.passenger?pid=ID-Website-ADR-Install_Button&c=Website_Download" ><img src="https://www.grab.com/id/wp-content/uploads/media/images/footer/google-play.png" class="img-responsive" /></a></li>
										</ul>
				</div><!-- /col-xs-12 col-md-4 -->
			</div><!-- /row-->
		</div><!-- /container -->
